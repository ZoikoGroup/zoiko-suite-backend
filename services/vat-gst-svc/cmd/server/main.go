...
import (
	...
	"zoiko.io/vat-gst-svc/internal/config"
	svcenvelope "zoiko.io/vat-gst-svc/internal/envelope"
...
func main() {
	...
	go func() {
		logger.Info("starting vat-gst-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down vat-gst-svc gracefully...")
