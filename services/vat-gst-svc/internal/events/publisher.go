...
type Publisher interface {
	Publish(ctx context.Context, eventType string, returnID string, tenantID string, payload interface{}) error
}
...
func (p *KafkaPublisher) Publish(ctx context.Context, eventType string, returnID string, tenantID string, payload interface{}) error {
	evt := Event{
