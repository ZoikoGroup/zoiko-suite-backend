...
import (
	...
	"zoiko.io/commercial-account-svc/internal/mtls"
...
func main() {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(ctx, cfg.MTLSManagementServiceURL, "commercial-account-svc", platformScopeID)
		if err != nil {
	...
	handler.RegisterSubscriptionV2Routes(r, handler.NewSubscriptionHandler(pgStore, authzClient, logger))
