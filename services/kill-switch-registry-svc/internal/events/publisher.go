...
// fabricated: kill switches are independently-nullable-scoped across
// plane/domain/provider/tenant (doc7 §32.1) — a platform-wide switch has
// no tenant, legal entity, or jurisdiction at all.
type Event struct {
