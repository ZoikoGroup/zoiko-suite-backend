...
func newClients(t *testing.T, ledgerURL string) *clients.Clients {
	t.Helper()
	return clients.New("http://authz.invalid", ledgerURL, "http://ap.invalid", "http://ar.invalid", "http://vault.invalid", "http://asset.invalid", "http://inventory.invalid", "http://project.invalid", zap.NewNop())
}
