...
func newAuthzClient(authzURL string) *clients.Clients {
	return clients.New(authzURL, "http://ledger.invalid", "http://ap.invalid", "http://ar.invalid", "http://vault.invalid", "http://asset.invalid", "http://inventory.invalid", zap.NewNop())
}
...
func TestUploadCloseEvidence_ReadsTheDocumentIDFromTheRealShape(t *testing.T) {
	...
	c := clients.New("http://authz.invalid", "http://ledger.invalid", "http://ap.invalid", "http://ar.invalid", srv.URL, "http://asset.invalid", "http://inventory.invalid", zap.NewNop())
