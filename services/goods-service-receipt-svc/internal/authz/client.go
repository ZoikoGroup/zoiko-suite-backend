...
// supplies resource_owner_principal_id so a receiver attempting to confirm
// or accept their own receipt, when that receipt is flagged as requiring
// independent acceptance, is genuinely denied by authorization-svc's own SoD
// rule evaluation, not by logic duplicated here — the same feature and
...
// CheckAllowedOwnObject is CheckAllowed plus resourceOwnerPrincipalID — see
