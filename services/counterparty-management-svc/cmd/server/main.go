...
import (
	...
	"zoiko.io/counterparty-management-svc/internal/config"
	svcenvelope "zoiko.io/counterparty-management-svc/internal/envelope"
	"zoiko.io/counterparty-management-svc/internal/events"
	"zoiko.io/counterparty-management-svc/internal/handler"
	"zoiko.io/counterparty-management-svc/internal/health"
	"zoiko.io/counterparty-management-svc/internal/middleware"
	"zoiko.io/counterparty-management-svc/internal/mtls"
	"zoiko.io/counterparty-management-svc/internal/store"
	"zoiko.io/counterparty-management-svc/internal/telemetry"
)

func main() {
	logger, err := telemetry.NewLogger("counterparty-management-svc")
	if err != nil {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(context.Background(), cfg.MTLSManagementServiceURL, "counterparty-management-svc", "00000000-0000-0000-0000-00000000f001")
		if err != nil {
	...
	go func() {
		logger.Info("starting counterparty-management-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down counterparty-management-svc gracefully...")
