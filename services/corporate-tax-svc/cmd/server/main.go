...
import (
	...
	"zoiko.io/corporate-tax-svc/internal/config"
	svcenvelope "zoiko.io/corporate-tax-svc/internal/envelope"
	"zoiko.io/corporate-tax-svc/internal/events"
	"zoiko.io/corporate-tax-svc/internal/handler"
	"zoiko.io/corporate-tax-svc/internal/health"
	"zoiko.io/corporate-tax-svc/internal/middleware"
	"zoiko.io/corporate-tax-svc/internal/mtls"
	"zoiko.io/corporate-tax-svc/internal/store"
	"zoiko.io/corporate-tax-svc/internal/telemetry"
)

func main() {
	logger, err := telemetry.NewLogger("corporate-tax-svc")
	if err != nil {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(context.Background(), cfg.MTLSManagementServiceURL, "corporate-tax-svc", "00000000-0000-0000-0000-00000000f001")
		if err != nil {
	...
	go func() {
		logger.Info("starting corporate-tax-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down corporate-tax-svc gracefully...")
