...
import (
	...
	"zoiko.io/filing-preparation-svc/internal/config"
	svcenvelope "zoiko.io/filing-preparation-svc/internal/envelope"
	"zoiko.io/filing-preparation-svc/internal/events"
	"zoiko.io/filing-preparation-svc/internal/evidencereq"
	"zoiko.io/filing-preparation-svc/internal/handler"
	"zoiko.io/filing-preparation-svc/internal/health"
	"zoiko.io/filing-preparation-svc/internal/middleware"
	"zoiko.io/filing-preparation-svc/internal/mtls"
	"zoiko.io/filing-preparation-svc/internal/store"
	"zoiko.io/filing-preparation-svc/internal/telemetry"
)

func main() {
	logger, err := telemetry.NewLogger("filing-preparation-svc")
	if err != nil {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(ctx, cfg.MTLSManagementServiceURL, "filing-preparation-svc", platformScopeID)
		if err != nil {
	...
	go func() {
		logger.Info("starting filing-preparation-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down filing-preparation-svc gracefully...")
