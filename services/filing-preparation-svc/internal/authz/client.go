...
// enforces fail-closed semantics: any error reaching the service, any
// non-200 response, or any decision other than "GRANTED" results in a
// non-nil error and the caller must refuse the guarded action.
