...
func TestStream_DoesNotBlockTheCaller(t *testing.T) {
	...
	c := siem.New(upstream.URL, "mtls-management-svc", zap.NewNop())
	defer c.Close()

	start := time.Now()
	c.Stream(context.Background(), testTenant, "certificate.revoked", siem.SeverityHigh, "denied")
...
func TestStream_DoesNotUseTheRequestContext(t *testing.T) {
	...
	c.Stream(ctx, testTenant, "certificate.revoked", siem.SeverityHigh, "denied")
...
func TestStream_DisabledStartsNothing(t *testing.T) {
	c := siem.New("", "mtls-management-svc", zap.NewNop())
...
func TestStream_NoTenantIsANoOp(t *testing.T) {
	...
	c := siem.New(upstream.URL, "mtls-management-svc", zap.NewNop())
	c.Stream(context.Background(), "", "certificate.revoked", siem.SeverityHigh, "denied")
	c.Close()
}
