...
// service, and payload schema version. domain.Notification carries real
// TenantID/LegalEntityID and a CreatedByPrincipalID actor — the principal
// who initiated the send, not RecipientPrincipalID, which is who the
// notification goes to, already carried separately in the payload. No
...
func (p *Publisher) PublishSent(ctx context.Context, correlationID string, n domain.Notification) {
	p.emit(ctx, "notification.sent", correlationID, n.TenantID, n.LegalEntityID, n.CreatedByPrincipalID, n.NotificationID, map[string]any{
...
func (p *Publisher) PublishFailed(ctx context.Context, correlationID string, n domain.Notification, reason string) {
	p.emit(ctx, "notification.failed", correlationID, n.TenantID, n.LegalEntityID, n.CreatedByPrincipalID, n.NotificationID, map[string]any{
		"notification_id":        n.NotificationID,
		"tenant_id":              n.TenantID,
		"legal_entity_id":        n.LegalEntityID,
		"recipient_principal_id": n.RecipientPrincipalID,
