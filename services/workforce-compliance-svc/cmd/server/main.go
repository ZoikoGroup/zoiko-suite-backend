...
import (
	...
	"zoiko.io/workforce-compliance-svc/internal/config"
	"zoiko.io/workforce-compliance-svc/internal/employee"
	svcenvelope "zoiko.io/workforce-compliance-svc/internal/envelope"
...
func main() {
	...
	go func() {
		logger.Info("starting workforce-compliance-svc server", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down workforce-compliance-svc server gracefully...")
