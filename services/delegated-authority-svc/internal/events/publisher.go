...
func (p *Publisher) PublishDelegated(ctx context.Context, d domain.DelegationGrant) {
	p.emit(ctx, "authority.delegated", d.CorrelationID, d.TenantID, d.LegalEntityID, d.CreatedByPrincipalID, d.DelegationID, map[string]any{
...
func (p *Publisher) PublishRevoked(ctx context.Context, d domain.DelegationGrant) {
	p.emit(ctx, "authority.revoked", d.CorrelationID, d.TenantID, d.LegalEntityID, deref(d.RevokedByPrincipalID), d.DelegationID, map[string]any{
		"delegation_id":   d.DelegationID,
		"legal_entity_id": d.LegalEntityID,
	})
}
...
func (p *Publisher) PublishExpired(ctx context.Context, d domain.DelegationGrant) {
	p.emit(ctx, "authority.expired", d.CorrelationID, d.TenantID, d.LegalEntityID, "", d.DelegationID, map[string]any{
		"delegation_id":   d.DelegationID,
		"legal_entity_id": d.LegalEntityID,
	})
}
