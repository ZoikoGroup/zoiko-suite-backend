...
// mtls-management-svc and builds the http.Client the authz caller uses to
// call authorization-svc over mutual TLS.
//
...
// inventory-management-svc is one of the rollout targets — most of this platform's
// other authorization-svc callers are being wired the same way one at a
// time (docs/original_doc/zoiko_suite_doc5.txt:76 mandates mTLS for
// "selected" paths, not all of them).
package mtls
