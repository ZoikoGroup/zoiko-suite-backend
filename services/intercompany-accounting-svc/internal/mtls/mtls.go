...
// intercompany-accounting-svc is one of a small number of callers wired for
// the pilot — most of this platform's ~70 other authorization-svc callers
// are deliberately left on the plain HTTP port for now (docs/original_doc/
