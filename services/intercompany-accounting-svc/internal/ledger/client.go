...
// used to verify that the source and target journals a caller claims
// balance an intercompany entry are each real, FINALIZED, belong to the
// right legal entity, and agree on amount.
//
