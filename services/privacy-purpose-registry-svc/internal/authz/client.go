...
// authorization-svc may be reused locally — see
// retention-registry-svc/internal/authz's identical constant for the full
// rationale (Doc 05 §6.5). Only real GRANTED/DENIED decisions are ever
// cached; an unreachable authorization-svc is never cached.
