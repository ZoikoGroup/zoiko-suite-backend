...
// that a principal is actually allowed to perform a given purchase request
// action.
//
// Doctrine (03-microservices.md): no service self-authorizes a material
// action. The Approve/Reject transitions are checked against
// authorization-svc synchronously, fail-closed — an unreachable
