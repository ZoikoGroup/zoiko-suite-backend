...
func Load() (*Config, error) {
	...
	return &Config{
		...
		KafkaEventsTopic:     getEnvOrDefault("KAFKA_EVENTS_TOPIC", "zoiko.contract.events"),
		...
		GovernanceLogURL:     getEnvOrDefault("GOVERNANCE_LOG_URL", "http://governance-svc:8083"),
	}, nil
}
