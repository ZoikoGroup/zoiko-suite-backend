...
var (
	...
	ErrGovernanceDecisionRequired = errors.New("governance_decision_id is required to activate a contract")
)
...
type ActivateContractRequest struct {
	...
	// decision that authorized this activation. Verified GRANTED before
	// the write proceeds — see handler.ActivateContract.
