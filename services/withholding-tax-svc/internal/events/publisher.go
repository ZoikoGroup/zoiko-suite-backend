...
// service, and payload schema version. domain.WithholdingTaxObligation
// carries real LegalEntityID and JurisdictionID fields.
...
func (p *KafkaPublisher) Publish(ctx context.Context, params PublishParams) error {
	evt := Event{
		...
		EventVersion:  "1.0",
		SourceService: "withholding-tax-svc",
