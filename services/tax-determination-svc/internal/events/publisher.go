...
// service, and payload schema version. domain.TaxDetermination carries
...
func (p *KafkaPublisher) Publish(ctx context.Context, params PublishParams) error {
	evt := Event{
		...
		EventVersion:    "1.0",
		SchemaVersion:   "1.0",
		SourceService:   "tax-determination-svc",
		DeterminationID: params.DeterminationID,
	...
	err = p.writer.WriteMessages(ctx, kafka.Message{
		Key:   []byte(params.DeterminationID),
		Value: data,
	})
	if err != nil {
