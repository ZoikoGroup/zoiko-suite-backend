...
import (
	...
	"zoiko.io/metric-registry-svc/internal/authz"
	"zoiko.io/metric-registry-svc/internal/config"
	svcenvelope "zoiko.io/metric-registry-svc/internal/envelope"
	"zoiko.io/metric-registry-svc/internal/events"
	"zoiko.io/metric-registry-svc/internal/handler"
	"zoiko.io/metric-registry-svc/internal/health"
	"zoiko.io/metric-registry-svc/internal/middleware"
	"zoiko.io/metric-registry-svc/internal/mtls"
	"zoiko.io/metric-registry-svc/internal/store"
	"zoiko.io/metric-registry-svc/internal/telemetry"
)
...
func main() {
	logger, err := telemetry.NewLogger("metric-registry-svc")
	if err != nil {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(ctx, cfg.MTLSManagementServiceURL, "metric-registry-svc", platformScopeID)
		if err != nil {
	...
	go func() {
		logger.Info("starting metric-registry-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down metric-registry-svc gracefully...")
