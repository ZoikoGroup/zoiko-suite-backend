...
import (
	...
	"zoiko.io/ai-governance-svc/internal/authz"
	"zoiko.io/ai-governance-svc/internal/config"
	svcenvelope "zoiko.io/ai-governance-svc/internal/envelope"
...
func main() {
	logger, err := telemetry.NewLogger("ai-governance-svc")
	if err != nil {
	...
	go func() {
		logger.Info("starting ai-governance-svc", zap.String("port", cfg.Port))
