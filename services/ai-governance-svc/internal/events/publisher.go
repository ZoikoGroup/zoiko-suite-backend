...
//
// LegalEntityID/Jurisdiction are correctly omitted, not fabricated: AI
// governance objects in this service (automation policies/actions, risk
// classifications) are platform/tenant-scoped, not legal-entity-scoped —
// there is no legal_entity_id anywhere on domain.AutomationAction to
// source it from.
type Event struct {
