...
import (
	...
	"zoiko.io/retention-registry-svc/internal/authz"
	"zoiko.io/retention-registry-svc/internal/config"
	svcenvelope "zoiko.io/retention-registry-svc/internal/envelope"
	"zoiko.io/retention-registry-svc/internal/events"
	"zoiko.io/retention-registry-svc/internal/handler"
...
func main() {
	logger, err := telemetry.NewLogger("retention-registry-svc")
	if err != nil {
	...
	go func() {
		logger.Info("starting retention-registry-svc", zap.String("port", cfg.Port))
