...
// Tenant-scope tests for reporting-orchestration-svc (Priority 1b).
//
...
func TestMissingTenantHeader_Refused(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{"Post /definitions", http.MethodPost, "/v1/reports/definitions"},
		{"Get /definitions", http.MethodGet, "/v1/reports/definitions"},
		{"Get /definitions/some-id", http.MethodGet, "/v1/reports/definitions/some-id"},
		{"Patch /definitions/some-id/status", http.MethodPatch, "/v1/reports/definitions/some-id/status"},
		{"Post /definitions/some-id/runs", http.MethodPost, "/v1/reports/definitions/some-id/runs"},
		{"Get /runs", http.MethodGet, "/v1/reports/runs"},
		{"Get /runs/r1", http.MethodGet, "/v1/reports/runs/r1"},
	} {
