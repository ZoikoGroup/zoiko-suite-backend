...
import (
	...
	"zoiko.io/obligation-tracking-svc/internal/config"
	svcenvelope "zoiko.io/obligation-tracking-svc/internal/envelope"
...
func main() {
	...
	go func() {
		logger.Info("starting obligation-tracking-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down obligation-tracking-svc gracefully...")
