...
import (
	...
	svcenvelope "zoiko.io/offboarding-severance-svc/internal/envelope"
	...
	"zoiko.io/offboarding-severance-svc/internal/mtls"
...
func main() {
	...
	if cfg.AuthzMTLSEnabled {
		mtlsHTTPClient, err := mtls.NewClientHTTPClient(ctx, cfg.MTLSManagementServiceURL, "offboarding-severance-svc", platformScopeID)
		if err != nil {
