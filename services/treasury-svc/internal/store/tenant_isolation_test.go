...
func cleanTables(t *testing.T) {
	...
	for _, stmt := range []string{
		...
		"DELETE FROM treasury_transfers; DELETE FROM cash_balances; DELETE FROM bank_account_ownership_evidence; DELETE FROM bank_account_history; DELETE FROM cash_position_snapshots; DELETE FROM bank_accounts; DELETE FROM liquidity_thresholds;",
