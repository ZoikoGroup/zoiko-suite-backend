...
// an idempotency key could duplicate its effect. Every cross-service call
// in this platform previously had a flat timeout and nothing else: one
// slow hop was a hard failure, which matters more on higher-latency
// international links than on a local dev network.
