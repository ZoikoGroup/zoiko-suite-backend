...
// NewHTTPClientWithClient is NewHTTPClient but with a caller-supplied
...
func NewHTTPClientWithClient(baseURL string, log *zap.Logger, httpClient *http.Client) *HTTPClient {
	return &HTTPClient{
		baseURL: baseURL,
		log:     log,
		http:    httpClient,
