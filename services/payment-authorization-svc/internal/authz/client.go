...
// supplies resource_owner_principal_id so the proposal's own preparer
// cannot also be the one who authorizes it — the fifth reuse of this
// feature this session, after supplier-financial-profile-svc (AP-01),
// goods-service-receipt-svc (AP-04), expense-claim-svc (AP-07), and
// payment-proposal-svc (AP-09).
package authz
