-- Migration: 000012_add_outbox_events.up.sql
--
-- ZS-STATE-001 Invariant I-13: Transactional Outbox for general-ledger-svc.
-- Guarantees atomic commitment of journal state mutations and their corresponding
