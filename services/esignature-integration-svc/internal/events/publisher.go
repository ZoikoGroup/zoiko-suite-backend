...
// service, and payload schema version. domain.SignatureEnvelope carries a
// real LegalEntityID but no jurisdiction or actor field, so actor_id is
...
func (p *KafkaPublisher) Publish(ctx context.Context, params PublishParams) error {
	evt := Event{
		...
		EventVersion:  "1.0",
		SourceService: "esignature-integration-svc",
