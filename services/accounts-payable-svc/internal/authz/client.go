...
// that a principal is actually allowed to perform a given invoice action.
//
// Doctrine (03-microservices.md): no service self-authorizes a material
// action. The Approve transition is checked against authorization-svc
...
// client is wired for real from day one (unlike some Phase 1 services that
// shipped with a documented stub-first posture).
package authz
