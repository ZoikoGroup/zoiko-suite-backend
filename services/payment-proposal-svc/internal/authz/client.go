...
// supplies resource_owner_principal_id so the principal who prepared a
// payment proposal cannot also be the one who freezes it — the fourth reuse
// of this feature this session, after supplier-financial-profile-svc
// (AP-01), goods-service-receipt-svc (AP-04), and expense-claim-svc (AP-07).
package authz
