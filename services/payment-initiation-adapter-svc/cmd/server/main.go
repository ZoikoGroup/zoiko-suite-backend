...
import (
	...
	"zoiko.io/payment-initiation-adapter-svc/internal/health"
...
func main() {
	...
	go func() {
		logger.Info("starting payment-initiation-adapter-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down payment-initiation-adapter-svc gracefully...")
