...
func Load() (*Config, error) {
	...
	return &Config{
		...
		KafkaEventsTopic:          getEnvOrDefault("KAFKA_EVENTS_TOPIC", "zoiko.supplier-recovery.events"),
		...
		BankReconciliationURL:     getEnvOrDefault("BANK_RECONCILIATION_SERVICE_URL", "http://bank-reconciliation-svc:8102"),
	}, nil
}
