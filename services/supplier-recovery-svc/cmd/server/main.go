...
import (
	...
	"zoiko.io/supplier-recovery-svc/internal/authz"
	"zoiko.io/supplier-recovery-svc/internal/bankreconciliation"
	"zoiko.io/supplier-recovery-svc/internal/config"
...
func main() {
	...
	go func() {
		logger.Info("starting supplier-recovery-svc", zap.String("port", cfg.Port))
