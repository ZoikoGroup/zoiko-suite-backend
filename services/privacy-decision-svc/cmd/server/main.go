...
import (
	...
	"zoiko.io/privacy-decision-svc/internal/config"
	...
	"zoiko.io/privacy-decision-svc/internal/health"
...
func main() {
	...
	go func() {
		logger.Info("starting privacy-decision-svc", zap.String("port", cfg.Port))
	...
	logger.Info("shutting down privacy-decision-svc gracefully...")
